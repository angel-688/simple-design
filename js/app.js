(() => {
    ...
    class Popup {
        constructor(options) {
            let config = {
                logging: true,
                init: true,
                attributeDelay: "data-popup-delay",
            ...
            document.addEventListener("click", function(e) {
                ...
                if (buttonOpen) {
                    ...
                    if (this._dataValue !== "error") {
                        ...
                        if (buttonOpen.hasAttribute(this.options.attributeDelay)) {
                            const delay = parseInt(buttonOpen.getAttribute(this.options.attributeDelay).trim());
                            setTimeout((() => {
                                this.open();
                            }), delay);
                        } else this.open();
        ...
        open(selectorValue) {
            if (bodyLockStatus) {
                ...
                if (this.targetOpen.element) {
                    ...
                    console.log(this.targetOpen.element);
        ...
        _openToHash() {
            ...
            this.youTubeCode = buttons && buttons.getAttribute(this.options.youtubeAttribute) ? buttons.getAttribute(this.options.youtubeAttribute) : null;
    ...
    function initSliders() {
        ...
        if (window.matchMedia("(max-width: 991.98px)").matches) if (document.querySelector(".section-design__slider")) new swiper_core_Swiper(".section-design__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
            ...
            speed: 700,
            navigation: {
                prevEl: ".section-design__arrow.arrow--prev",
                nextEl: ".section-design__arrow.arrow--next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
        ...
        if (document.querySelector(".slide-design__slider")) {
            const designSlider = new swiper_core_Swiper(".slide-design__slider", {
                modules: [ Pagination ],
                nested: true,
                pagination: {
                    el: ".slide-design__pagination",
                    clickable: true
                },
                on: {}
            });
            function slideMoveChange() {
                document.addEventListener("mousemove", (function(e) {
                    ...
                    if (targetElement.closest("[data-mousemove-swipe]")) {
                        ...
                        const sliderContainer = sliderElement.closest("[class*=__container]");
                        const sliderItem = designSlider[getIndex(sliderElement)];
                        const sliderLength = sliderItem.slides.length;
                        if (sliderLength > 1) {
                            const sliderWidth = sliderItem.width;
                            const sliderPath = Math.round(sliderWidth / sliderLength);
                            const sliderMousePos = e.clientX - sliderContainer.offsetLeft - sliderElement.offsetLeft;
                ...
                function getIndex(el) {
                    return Array.from(el.closest("[data-mousemove-parent]").querySelectorAll("[data-mousemove-swipe]")).indexOf(el);
                }
            }
            if (window.matchMedia("(min-width: 991.98px)").matches) slideMoveChange();
        }
        if (document.querySelector(".product__slider")) new swiper_core_Swiper(".product__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".arrow--prod.arrow--prev",
                nextEl: ".arrow--prod.arrow--next"
            },
            breakpoints: {
                320: {
                    spaceBetween: 10
        ...
        if (window.matchMedia("(max-width: 991.98px)").matches) if (document.querySelector(".add__slider")) new swiper_core_Swiper(".add__slider", {
            observer: true,
            observeParents: true,
            slidesPerView: 2.2,
            spaceBetween: 30,
    ...
    window.addEventListener("load", (function(e) {
        ...
        if (cart) {
            window.addEventListener("scroll", (function(e) {
                ...
                if (scroll === 0) cart.classList.remove("_show"); else cart.classList.add("_show");
            }));
            if (window.matchMedia("(min-width: 991.98px)").matches) cart.addEventListener("mouseenter", (function(e) {
                cart.classList.remove("_show");
            }));
        }
    }));
    window["FLS"] = true;
